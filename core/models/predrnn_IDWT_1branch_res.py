...
class RNN(nn.Module):
    def __init__(self, num_layers, num_hidden, configs):
        ...
        for i in range(num_layers):
            ...
            cell_list.append(
                SpatioTemporalLSTMCell(in_channel, num_hidden[i],width, width, configs.filter_size, stride=configs.stride, layer_norm=configs.layer_norm))
